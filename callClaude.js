...
exports.handler = async (event) => {
  ...
  try {
    ...
    try {
      ...
      return { statusCode: 502, body: JSON.stringify({ error: 'Impossible de joindre Firebase Auth pour vérifier la session : ' + netErr.message, code: 'auth/verify-network-error' }) };
    }
    ...
    try {
      ...
      return { statusCode: 502, body: JSON.stringify({ error: 'Impossible de joindre l\'API Gemini : ' + netErr.message, code: 'gemini/network-error' }) };
    }
